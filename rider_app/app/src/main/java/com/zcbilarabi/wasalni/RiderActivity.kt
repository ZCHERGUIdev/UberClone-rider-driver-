...
import com.zcbilarabi.wasalni.dao.OrderDao
import com.zcbilarabi.wasalni.dao.UserDao
import com.zcbilarabi.wasalni.modal.Order
import com.zcbilarabi.wasalni.modal.OrderStatus
...
var loc=LatLng(returnedUser.location!!.latitude,returnedUser.location!!.longitude)
    ...
    private fun Getcurruentlocation() {
        ...
        locationmanager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 400, 1f, locationOnmap)
    }
